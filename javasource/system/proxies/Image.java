...
public class Image extends system.proxies.FileDocument
{
	...
	{
		if (com.mendix.core.Core.isSubClassOf("SoccerSquad.Logo", mendixObject.getType())) {
			return soccersquad.proxies.Logo.initialize(context, mendixObject);
		}
		if (com.mendix.core.Core.isSubClassOf("SoccerSquad.ProfilePicture", mendixObject.getType())) {
