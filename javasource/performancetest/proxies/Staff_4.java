...
public class Staff_4
{
	private final com.mendix.systemwideinterfaces.core.IMendixObject staff_4MendixObject;
	 ...
	 */
	public static final java.lang.String entityName = "PerformanceTest.Staff_4";
	...
	public Staff_4(com.mendix.systemwideinterfaces.core.IContext context)
	{
		this(context, com.mendix.core.Core.instantiate(context, entityName));
	}

	protected Staff_4(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject staff_4MendixObject)
	{
		if (staff_4MendixObject == null) {
			throw new java.lang.IllegalArgumentException("The given object cannot be null.");
		}
		if (!com.mendix.core.Core.isSubClassOf(entityName, staff_4MendixObject.getType())) {
			throw new java.lang.IllegalArgumentException(String.format("The given object is not a %s", entityName));
		}	

		this.staff_4MendixObject = staff_4MendixObject;
		this.context = context;
	}

	/**
	 * @deprecated Use 'Staff_4.load(IContext, IMendixIdentifier)' instead.
	 */
	@java.lang.Deprecated
	public static performancetest.proxies.Staff_4 initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		return performancetest.proxies.Staff_4.load(context, mendixIdentifier);
	}
	 ...
	 */
	public static performancetest.proxies.Staff_4 initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixObject)
	{
		return new performancetest.proxies.Staff_4(context, mendixObject);
	}

	public static performancetest.proxies.Staff_4 load(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		com.mendix.systemwideinterfaces.core.IMendixObject mendixObject = com.mendix.core.Core.retrieveId(context, mendixIdentifier);
		return performancetest.proxies.Staff_4.initialize(context, mendixObject);
	}

	public static java.util.List<performancetest.proxies.Staff_4> load(com.mendix.systemwideinterfaces.core.IContext context, java.lang.String xpathConstraint) throws com.mendix.core.CoreException
	{
	...
	public boolean equals(Object obj)
	{
		...
		{
			final performancetest.proxies.Staff_4 that = (performancetest.proxies.Staff_4) obj;
