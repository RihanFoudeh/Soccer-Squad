...
public class Staff
{
	 ...
	 */
	public static final java.lang.String entityName = "PerformanceTest.Staff";
	...
	public static performancetest.proxies.Staff initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		return performancetest.proxies.Staff.load(context, mendixIdentifier);
	}
	 ...
	 */
	public static performancetest.proxies.Staff initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixObject)
	{
		return new performancetest.proxies.Staff(context, mendixObject);
	}

	public static performancetest.proxies.Staff load(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		com.mendix.systemwideinterfaces.core.IMendixObject mendixObject = com.mendix.core.Core.retrieveId(context, mendixIdentifier);
		return performancetest.proxies.Staff.initialize(context, mendixObject);
	}

	public static java.util.List<performancetest.proxies.Staff> load(com.mendix.systemwideinterfaces.core.IContext context, java.lang.String xpathConstraint) throws com.mendix.core.CoreException
	{
	 ...
	 */
	public final java.util.List<performancetest.proxies.Team> getStaff_Team() throws com.mendix.core.CoreException
	{
	...
	public final java.util.List<performancetest.proxies.Team> getStaff_Team(com.mendix.systemwideinterfaces.core.IContext context) throws com.mendix.core.CoreException
	{
		java.util.List<performancetest.proxies.Team> result = new java.util.ArrayList<>();
		...
		for (com.mendix.systemwideinterfaces.core.IMendixObject mendixObject : com.mendix.core.Core.retrieveIdList(context, (java.util.List<com.mendix.systemwideinterfaces.core.IMendixIdentifier>) valueObject)) {
			result.add(performancetest.proxies.Team.initialize(context, mendixObject));
		}
		return result;
	}
	 ...
	 * @param staff_team
	 */
	public final void setStaff_Team(java.util.List<performancetest.proxies.Team> staff_team)
	{
	 ...
	 * @param staff_team
	 */
	public final void setStaff_Team(com.mendix.systemwideinterfaces.core.IContext context, java.util.List<performancetest.proxies.Team> staff_team)
	{
	...
	public boolean equals(Object obj)
	{
		...
		{
			final performancetest.proxies.Staff that = (performancetest.proxies.Staff) obj;
