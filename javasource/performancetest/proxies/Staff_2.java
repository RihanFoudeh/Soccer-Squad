...
public class Staff_2
{
	private final com.mendix.systemwideinterfaces.core.IMendixObject staff_2MendixObject;
	 ...
	 */
	public static final java.lang.String entityName = "PerformanceTest.Staff_2";
	...
	public Staff_2(com.mendix.systemwideinterfaces.core.IContext context)
	{
		this(context, com.mendix.core.Core.instantiate(context, entityName));
	}

	protected Staff_2(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject staff_2MendixObject)
	{
		if (staff_2MendixObject == null) {
			throw new java.lang.IllegalArgumentException("The given object cannot be null.");
		}
		if (!com.mendix.core.Core.isSubClassOf(entityName, staff_2MendixObject.getType())) {
			throw new java.lang.IllegalArgumentException(String.format("The given object is not a %s", entityName));
		}	

		this.staff_2MendixObject = staff_2MendixObject;
		this.context = context;
	}

	/**
	 * @deprecated Use 'Staff_2.load(IContext, IMendixIdentifier)' instead.
	 */
	@java.lang.Deprecated
	public static performancetest.proxies.Staff_2 initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		return performancetest.proxies.Staff_2.load(context, mendixIdentifier);
	}
	 ...
	 */
	public static performancetest.proxies.Staff_2 initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixObject)
	{
		return new performancetest.proxies.Staff_2(context, mendixObject);
	}

	public static performancetest.proxies.Staff_2 load(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		com.mendix.systemwideinterfaces.core.IMendixObject mendixObject = com.mendix.core.Core.retrieveId(context, mendixIdentifier);
		return performancetest.proxies.Staff_2.initialize(context, mendixObject);
	}

	public static java.util.List<performancetest.proxies.Staff_2> load(com.mendix.systemwideinterfaces.core.IContext context, java.lang.String xpathConstraint) throws com.mendix.core.CoreException
	{
	...
	public boolean equals(Object obj)
	{
		...
		{
			final performancetest.proxies.Staff_2 that = (performancetest.proxies.Staff_2) obj;
